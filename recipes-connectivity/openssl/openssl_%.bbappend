...
do_install:append() {
    ...
    install -m 644 ${UNPACKDIR}/95-sslgenkeys.preset ${D}${systemd_unitdir}/system-preset/

    install -d                                ${D}${sbindir}/
    install -m 755 ${UNPACKDIR}/sslgenkeys.sh ${D}${sbindir}/
    install -m 755 ${UNPACKDIR}/ssldelkeys.sh ${D}${sbindir}/

    install -d                                      ${D}${systemd_unitdir}/system/
    install -m 0644 ${UNPACKDIR}/sslgenkeys.service ${D}${systemd_unitdir}/system/
